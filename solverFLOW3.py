...
# -----
    ...
    print("\n\nGREED CONSTRUCTION WT RANDOM TIE-BREAKING")
    ...
    print(f'Mean Time : {execution_time1/n}')
    
    # Run greed_randomize_adaptive_construction 10 times
    print("\n\nGREED RANDOMIZE ADAPTIVE CONSTRUCTION")
    ...
    print(f'Mean Time : {execution_time2/n}')
    ...
    print(f'Mean Time : {execution_time3/n}')

    # Run best_improvement 10 times
    print("\n\nBEST IMPROVEMENT")
    start_time4 = time.time()
    for i in range(n):
        start_time = time.time()
        sol5 = best_improvement(prob.initial_solution())
        end_time = time.time()
        execution_time = end_time - start_time
        print(f'Run {i+1} - Obj: {"{:.2f}".format(sol5.objective())}, Sol: {sol5}, Time: {execution_time}')
    end_time4 = time.time()
    execution_time4 = end_time4 - start_time4
    print(f'Mean Time : {execution_time4/n}')

    # Run first_improvement 10 times
    print("\n\nFIRST IMPROVEMENT")
    start_time5 = time.time()
    for i in range(n):
        start_time = time.time()
        sol6 = first_improvement(prob.initial_solution())
        end_time = time.time()
        execution_time = end_time - start_time
        print(f'Run {i+1} - Obj: {"{:.2f}".format(sol6.objective())}, Sol: {sol6}, Time: {execution_time}')
    end_time5 = time.time()
    execution_time5 = end_time5 - start_time5
    print(f'Mean Time : {execution_time5/n}')